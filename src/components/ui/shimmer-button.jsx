...
export const ShimmerButton = React.forwardRef((
  ...
  return (
    <button
      ...
      className={cn(
        "group relative z-0 opacity-80 flex cursor-pointer items-center justify-center overflow-hidden [border-radius:var(--radius)] border border-white/10 px-6 py-3 whitespace-nowrap text-white [background:var(--bg)]",
